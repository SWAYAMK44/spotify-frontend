...
async function main() {
  ...
  let sinbtnc =document.getElementById("sinbtn")
  sinbtnc.addEventListener("click",()=>{
    document.querySelector(".sinform").style.display="block"
    document.querySelector(".container").style.opacity="0.2"
    
})
  let close=document.getElementById("c")
  close.addEventListener("click",()=>{
    document.querySelector(".sinform").style.display="none"
